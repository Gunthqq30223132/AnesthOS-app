...
| **CD auto-deploy sau merge (proposal 14-step điểm 5) — HOÃN Phase 3** | Hệ chưa ship một feature thật nào (First Light là task viết test); thêm deploy/VPS/secret bây giờ là mở mặt rủi ro mới quá sớm. VÀ auto-deploy-on-merge phá tính chịu-dừng (D1: Chủ là cổng dừng có chủ đích). Khi làm ở Phase 3: **deploy phải là một cổng người RIÊNG, không phải hệ quả tự động của merge** |
